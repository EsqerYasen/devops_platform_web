...
class Module(models.Model):
    ...
    open_db = models.CharField(max_length=255, verbose_name="数据库名称", null=False)
    open_table = models.CharField(max_length=255, verbose_name="数据表名称", null=False)
    open_id = models.IntegerField(verbose_name="数据记录ID", null=False)
