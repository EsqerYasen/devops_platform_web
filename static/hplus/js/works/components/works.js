...
var transLocalToApiData = function(basic, steps){
  ...
  for(var i=0; i<steps.length; i++ ){
    ...
    res.steps[i] = {lines:[],name:steps[i].name, is_skip:steps[i].is_skip?1:0, activeIndex:steps[i].activeIndex, seq_no:i+1, target_group_ids:steps[i].target_group_ids,target_host_list:steps[i].target_host_list };
