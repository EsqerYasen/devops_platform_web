...
},{"./model":3,"./view":20,"backbone":4,"underscore":6}],2:[function(require,module,exports){
var $ = require('jquery');
var Backbone = require('backbone');
Backbone.$ = $;
...
},{"./app":1,"backbone":4,"jquery":5}],3:[function(require,module,exports){
var Backbone = require('backbone');
var $ = require('jquery');
...
with (locals || {}) { (function(){ 
 buf.push('');1;if (locals.tabs && locals.tabs.length){; buf.push('\n    <ul class="nav nav-tabs">\n        ');3;$.each(locals.tabs, function(i, tab){; buf.push('\n          <li class="', escape((4, tab.active ? 'active': '')), '"><a href="#', escape((4, tab.route_to)), '">', escape((4, tab.text)), '</a></li>\n        ');5; }) ; buf.push('\n    </ul>\n');7; } ; buf.push('\n');8;console.log(locals, locals.userInfo);; buf.push('\n');9;if (locals.buttons && locals.buttons.length){; buf.push('\n    ');10;if(locals.userInfo && (locals.userInfo.admin || locals.isOwner)){; buf.push('\n        <div class="pull-right">\n            ');12;$.each(locals.buttons, function(i, button){; buf.push('\n              <button data-text="', escape((13, button.text)), '" class="', escape((13, button.kls)), ' btn-primary" data-id="', escape((13, button.id)), '" data-type="', escape((13, button.type)), '" >', escape((13, button.text)), '</button>\n            ');14; }) ; buf.push('\n        </div>\n    ');16; } ; buf.push('\n');17; } ; buf.push('\n');18;if (1 || (locals.list && locals.list.length)){; buf.push('\n    <table class="table table-hover table-condensed table-striped responsive">\n\n            <tr>\n                <th class="margin_t_10 text-center text_22px col-md-1 col-xs-1 col-sm-1">\n                    #\n                </th>\n                <th class="margin_t_10 text-center text_22px col-md-4 col-xs-4 col-sm-4">\n                    名称\n                </th>\n                ');28;if(!locals.no_privilege){; buf.push('\n                    <th class="', escape((29, locals.no_privilege? 'hide':'')), ' checkbox margin_t_10 text-center text_22px col-md-4 col-xs-4 col-sm-4">\n                        权限\n                    </th>\n                ');32;}; buf.push('\n                <th class="margin_t_10 text-center text_22px col-md-3 col-xs-3 col-sm-3">\n                    修改\n                </th>\n            </tr>\n            ');37; (locals.list || []).forEach(function(item, i){ ; buf.push('\n                ', (38,  require('./partials/grid_row.ejs')({i: i, item: item, modalEditTitle: modalEditTitle, no_privilege:locals.no_privilege, no_edit: locals.no_edit, userInfo: locals.userInfo, grid_type: locals.grid_type, routingid: locals.routingid}) ), '\n            ');39; }) ; buf.push('\n    </table>\n');41;}; buf.push(''); })();
} 
return buf.join('');
})
},{"./partials/grid_row.ejs":9}],8:[function(require,module,exports){
module.exports = (function anonymous(locals, filters, escape, rethrow) {
escape = escape || function (html){
  return String(html)
    .replace(/&/g, '&amp;')
...
var buf = [];
with (locals || {}) { (function(){ 
 buf.push('<nav class="items-list">\n    <ul class="list-unstyled list-group">\n        ');3;console.log(locals.list, JSON.stringify(locals.list)); buf.push('\n        ');4; $.each(locals.list || [], function(i, item){ ; buf.push('\n            ', (5,  require('./partials/list_menu.ejs')({i: i, item: item,  route_to: locals.route_to, key_field: locals.key_field, name_field:locals.name_field }) ), '\n        ');6; }) ; buf.push('\n    </ul>\n</nav>\n'); })();
} 
return buf.join('');
})
},{"./partials/list_menu.ejs":10}],9:[function(require,module,exports){
module.exports = (function anonymous(locals, filters, escape, rethrow) {
escape = escape || function (html){
  return String(html)
    .replace(/&/g, '&amp;')
...
var buf = [];
with (locals || {}) { (function(){ 
 buf.push('');1;if(item) {; buf.push('\n    <tr>\n        <td class="margin_t_10 text-center text_22px col-md-1 col-xs-1 col-sm-1 align-baseline">\n            <div class="lh_38">\n                <div class="lh_38">', escape((5, i)), '</div>\n            </div>\n        </td>\n        <td class="margin_t_10 text-center text_22px col-md-4 col-xs-4 col-sm-4 align-baseline">\n            <div class="lh_38">', escape((9,  item.name)), '</div>\n        </td>\n        ');11;console.log(1111, locals.userInfo, item, item.owner_id, locals.userInfo.userid, item.owner_id==locals.userInfo.userid);; buf.push('\n        ');12;if(!locals.no_privilege && ( (locals.userInfo && locals.userInfo.admin) || (locals.userInfo.userid==item.owner_id))){; buf.push('\n        <td class="', escape((13, locals.no_privilege? 'hide':'')), ' checkbox margin_t_10 text-center text_22px col-md-4 col-xs-4 col-sm-4 align-baseline">\n            ');14;if( ( (locals.userInfo && locals.userInfo.admin) || (locals.userInfo.userid==item.owner_id))){; buf.push('\n            <div class="btn-group lh_38 " data-toggle="buttons" >\n                <label class="btn btn-primary inline-block ', escape((16, item.privilege === 1? "active":"" )), '"> <input class="inline-block" type="radio" name="privilege[', escape((16, i)), ']" value="1"> 可读</label>\n\n                <label class="btn btn-primary  inline-block  ', escape((18, item.privilege === 2? "active":"" )), '"> <input class="inline-block " type="radio" name="privilege[', escape((18, i)), ']"  value="2"> 运行</label>\n\n                <label class="btn btn-primary  inline-block  ', escape((20, item.privilege === 4? "active":"" )), '"> <input class="inline-block" type="radio" name="privilege[', escape((20, i)), ']" value="4"> 配置</label>\n            </div>\n            ');22;}; buf.push('\n        </td>\n        ');24;}; buf.push('\n\n        <td class="margin_t_10 text-center text_22px col-md-3 col-xs-3 col-sm-3 align-baseline">\n            ');27;if( ( (locals.userInfo && locals.userInfo.admin) || (locals.userInfo.userid==item.owner_id))){; buf.push('\n            <div class="lh_38">\n                ');29;if (!locals.no_edit) {; buf.push('\n                    <label class="', escape((30, locals.no_edit? 'hide':'')), '">\n                    <input\n                        class="form-control fs_16 btn_edit btn btn-primary"\n                        type="button"\n                        name="operation"\n                        data-item="', escape((35, JSON.stringify(item))), '"\n                        data-id="', escape((36, item.id)), '"\n                        data-type="', escape((37, locals.grid_type)), '"\n                        data-name="', escape((38, item.name)), '"\n                        data-privilege="', escape((39, item.privilege)), '"\n                        data-routingid="', escape((40, locals.routingid)), '"\n                        value="编辑"\n                        data-edittitle="', escape((42, modalEditTitle)), '">\n                    </label>\n                ');44;}; buf.push('\n                <label>\n                <input\n                    class="form-control fs_16 btn_remove btn btn-primary"\n                    type="button"\n                    name="operation"\n                    data-item="', escape((50, JSON.stringify(item))), '"\n                    data-type="', escape((51, locals.grid_type)), '"\n                    data-routingId="', escape((52, locals.routingid)), '"\n                    data-id="', escape((53, item.id)), '" value="删除">\n                </label>\n            </div>\n            ');56;}; buf.push('\n        </td>\n    </tr>\n');59;}; buf.push('\n'); })();
} 
return buf.join('');
})
...
var buf = [];
with (locals || {}) { (function(){ 
 buf.push('');1;if (locals.route_to && locals.item && locals.key_field && locals.name_field) {; buf.push('\n    <li class="list-group-item">\n        <div class="margin_t_10 text_align_center text_22px">\n            <a href="#/', escape((4, locals.route_to)), '/', escape((4, locals.item[locals.key_field])), '">', escape((4,  locals.item[locals.name_field])), '</a>\n        </div>\n    </li>\n');7;}; buf.push(''); })();
} 
return buf.join('');
})
...
var buf = [];
with (locals || {}) { (function(){ 
 buf.push('');1;if (btn) {; buf.push('\n<button\n    class="btn btn btn-default modal_', escape((3, btn.source)), '_', escape((3, btn.kls)), ' ', escape((3, btn.kls)), ' pull-right"\n    type="button"\n    data-id="', escape((5, btn.id)), '"\n    data-source="', escape((6, btn.source)), '"\n    >\n    ', escape((8, btn.label)), '\n</button>\n');10;}; buf.push('\n'); })();
} 
return buf.join('');
})
...
var buf = [];
with (locals || {}) { (function(){ 
 buf.push('');1;if(locals.list) {; buf.push('\n    <div class="row">\n        <div class="col-md-1 col-xs-1 col-sm-1"/>\n\n        <div class="col-md-5 col-xs-5 col-sm-5 userInfo">\n\n            ');7;if (locals.inputTitle) {; buf.push('\n            <div class="input row input inputTitle input_row">\n                <div>\n                    <label>', escape((10, locals.inputTitle? locals.inputTitle: '')), '</label>\n                    <input type="text" name="name" class="inputTitle select_name" placeholder="请输入', escape((11, locals.inputTitle? locals.inputTitle: '')), '">\n                </div>\n                <div class="modal_error_msg">\n                    请输入', escape((14, locals.inputTitle? locals.inputTitle: '')), '\n                </div>\n            </div>\n            ');17;}; buf.push('\n\n            ');19;if (locals.inputTitle2) {; buf.push('\n            <div class="row input inputTitle2 input_row">\n                <div>\n                    <label>', escape((22, locals.inputTitle2? locals.inputTitle2: '')), '</label>\n                    <input type="text" name="name" class="inputTitle2 select_name" placeholder="请输入', escape((23, locals.inputTitle2? locals.inputTitle2: '')), '">\n                </div>\n                <div class="modal_error_msg">\n                    请输入', escape((26, locals.inputTitle2? locals.inputTitle2: '')), '\n                </div>\n            </div>\n            ');29;}; buf.push('\n\n            ');31;if (locals.inputTitle3) {; buf.push('\n            <div class="row input inputTitle3 input_row">\n                <div>\n                    <label>', escape((34, locals.inputTitle3? locals.inputTitle3: '')), '</label>\n                    <input type="text" name="name" class="inputTitle3 select_name" placeholder="请输入', escape((35, locals.inputTitle3? locals.inputTitle3: '')), '">\n                </div>\n                <div class="modal_error_msg">\n                    请输入', escape((38, locals.inputTitle3? locals.inputTitle3: '')), '\n                </div>\n            </div>\n            ');41;}; buf.push('\n            ');42;if (locals.inputTitle4) {; buf.push('\n            <div class="row input inputTitle4 input_row">\n                <div>\n                    <label>', escape((45, locals.inputTitle4? locals.inputTitle4: '')), '</label>\n                    <input type="text" name="name" class="inputTitle4 select_name" placeholder="请输入', escape((46, locals.inputTitle4? locals.inputTitle4: '')), '">\n                </div>\n                <div class="modal_error_msg">\n                    请输入', escape((49, locals.inputTitle4? locals.inputTitle4: '')), '\n                </div>\n            </div>\n            ');52;}; buf.push('\n            ');53;if (locals.inputTitle5) {; buf.push('\n            <div class="row input inputTitle5 input_row">\n                <div>\n                    <label>', escape((56, locals.inputTitle5? locals.inputTitle5: '')), '</label>\n                    <input type="text" name="name" class="inputTitle5 select_name" placeholder="请输入', escape((57, locals.inputTitle5? locals.inputTitle5: '')), '">\n                </div>\n                <div class="modal_error_msg">\n                    请输入', escape((60, locals.inputTitle5? locals.inputTitle5: '')), '\n                </div>\n            </div>\n            ');63;}; buf.push('\n            ');64;if (locals.inputTitle6) {; buf.push('\n            <div class="row input inputTitle6 input_row">\n                <div>\n                    <label>', escape((67, locals.inputTitle6? locals.inputTitle6: '')), '</label>\n                    <input type="text" name="name" class="inputTitle6 select_name" placeholder="请输入', escape((68, locals.inputTitle6? locals.inputTitle6: '')), '">\n                </div>\n                <div class="modal_error_msg">\n                    请输入', escape((71, locals.inputTitle6? locals.inputTitle6: '')), '\n                </div>\n            </div>\n            ');74;}; buf.push('\n            <div class="row select">\n                <label>', escape((76, locals.selectTitle? locals.selectTitle: '')), '</label>\n                <select class="select_module">\n                    <option value="-1">Select</option>\n                ');79; (locals.list || []).forEach(function(item, i){ ; buf.push('\n                    <option value="', escape((80, item[locals.keyField])), '">', escape((80, item[locals.valField])), '</option>\n                ');81;}); buf.push('\n                </select>\n                <div class="modal_error_msg">\n                    请选择', escape((84, locals.selectTitle? locals.selectTitle: '')), '\n                </div>\n            </div>\n        </div>\n        ');88;if (!locals.disable_privilege) {; buf.push('\n            <div class="col-md-5 col-xs-5 col-sm-5 privilege btn-privilege">\n                <div class="row">\n                <fieldset class="col-md-12 col-xs-12 col-sm-12">\n                    <legend>权限</legend>\n\n                    <div class="btn-group" data-toggle="buttons">\n                        <label class="btn btn-primary ">\n                            <input type="radio" name="privilege"  value="1"> 只读\n                        </label>\n                        <label class="btn btn-primary ">\n                            <input type="radio" name="privilege"  value="2"> 运行\n                        </label>\n                        <label class="btn btn-primary ">\n                            <input type="radio" name="privilege"  value="4"> 编辑\n                        </label>\n                    </div>\n                </fieldset>\n                </div>\n                <div class="modal_error_msg">\n                    请选择权限\n                </div>\n            </div>\n        ');111;}; buf.push('\n    </div>\n');113;}; buf.push('\n'); })();
} 
return buf.join('');
})
...
var buf = [];
with (locals || {}) { (function(){ 
 buf.push('');1;if(locals.list) {; buf.push('\n    <div class="row">\n        <div class="col-md-1 col-xs-1 col-sm-1"/>\n        <div class="col-md-5 col-xs-5 col-sm-5 userInfo">\n            <div class="row select">\n                <label>', escape((6, locals.selectTitle? locals.selectTitle: '')), '</label>\n                <select class="select_module">\n                    <option value="-1">Select</option>\n                ');9; (locals.list || []).forEach(function(item, i){ ; buf.push('\n                    <option value="', escape((10, item[locals.keyField])), '">', escape((10, item[locals.valField])), '</option>\n                ');11;}); buf.push('\n                </select>\n                <div class="modal_error_msg">\n                    请选择', escape((14, locals.selectTitle? locals.selectTitle: '')), '\n                </div>\n            </div>\n        </div>\n        ');18;if (!locals.disable_privilege) {; buf.push('\n            <div class="col-md-5 col-xs-5 col-sm-5 privilege btn-privilege">\n                <div class="row">\n                <fieldset class="col-md-12 col-xs-12 col-sm-12">\n                    <legend>权限</legend>\n\n                    <div class="btn-group" data-toggle="buttons">\n                        <label class="btn btn-primary ">\n                            <input type="radio" name="privilege"  value="1"> 只读\n                        </label>\n                        <label class="btn btn-primary ">\n                            <input type="radio" name="privilege"  value="2"> 运行\n                        </label>\n                        <label class="btn btn-primary ">\n                            <input type="radio" name="privilege"  value="4"> 编辑\n                        </label>\n                    </div>\n                </fieldset>\n                </div>\n                <div class="modal_error_msg">\n                    请选择权限\n                </div>\n            </div>\n        ');41;}; buf.push('\n    </div>\n');43;}; buf.push('\n'); })();
} 
return buf.join('');
})
...
var buf = [];
with (locals || {}) { (function(){ 
 buf.push('');1;if(locals.data) {; buf.push('\n    <div class="row">\n        <div class="col-md-6 col-xs-6 col-sm-6 userInfo">\n            ', escape((4, data.name)), '\n        </div>\n        <div class="col-md-6 col-xs-6 col-sm-6 privilege">\n            <fieldset class="col-md-12 col-xs-12 col-sm-12">\n                <legend>权限</legend>\n\n                <div class="btn-group" data-toggle="buttons">\n                    <label class="btn btn-primary ', escape((11, data.privilege === 1? "active":"" )), '">\n                        <input type="radio" name="privilege" ', escape((12, data.privilege === 1? "checked":"" )), ' value="1"> 只读\n                    </label>\n                    <label class="btn btn-primary ', escape((14, data.privilege === 2? "active":"" )), '">\n                        <input type="radio" name="privilege" ', escape((15, data.privilege === 2? "checked":"" )), '  value="2"> 运行\n                    </label>\n                    <label class="btn btn-primary ', escape((17, data.privilege === 4? "active":"" )), '">\n                        <input type="radio" name="privilege"  ', escape((18, data.privilege === 4? "checked":"" )), '  value="4"> 编辑\n                    </label>\n                </div>\n            </fieldset>\n        </div>\n    </div>\n');24;}; buf.push('\n'); })();
} 
return buf.join('');
})
...
var buf = [];
with (locals || {}) { (function(){ 
 buf.push('');1;if(locals.list) {; buf.push('\n    <div class="row">\n        <div class="col-md-6 col-xs-6 col-sm-6 userInfo">\n            ');4;if(locals.text_label) {; buf.push('\n                <div>\n                    <label>', escape((6, locals.text_label)), '</label>\n                    <input name="', escape((7, locals.text_name)), '" class="', escape((7, locals.text_kls)), '">\n                </div>\n            ');9;}; buf.push('\n            <div>\n            <label>', escape((11, locals.list_label)), '</label>\n            <select name="', escape((12, locals.list_name)), '"  class="', escape((12, locals.list_kls)), '">\n                <option value="-1">Select</option>\n            ');14; (locals.list || []).forEach(function(item, i){ ; buf.push('\n                <option value="', escape((15, item[locals.keyField])), '">', escape((15, item[locals.valField])), '</option>\n            ');16;}); buf.push('\n            </select>\n            </div>\n\n        </div>\n        <div class="col-md-6 col-xs-6 col-sm-6 privilege">\n            <fieldset class="col-md-12 col-xs-12 col-sm-12">\n                <legend>权限</legend>\n\n                <div class="btn-group" data-toggle="buttons">\n                    <label class="btn btn-primary ">\n                        <input type="radio" name="privilege"  value="1"> 只读\n                    </label>\n                    <label class="btn btn-primary ">\n                        <input type="radio" name="privilege"  value="2"> 运行\n                    </label>\n                    <label class="btn btn-primary ">\n                        <input type="radio" name="privilege"  value="4"> 编辑\n                    </label>\n                </div>\n            </fieldset>\n        </div>\n    </div>\n');39;}; buf.push(''); })();
} 
return buf.join('');
})
...
var buf = [];
with (locals || {}) { (function(){ 
 buf.push('');1;if(user) {; buf.push('\n    <div class="row">\n        <div class="col-md-6 col-xs-6 col-sm-6 userInfo">\n            ', escape((4, user.moduleName)), '\n        </div>\n        <div class="col-md-6 col-xs-6 col-sm-6 privilege">\n            <fieldset class="col-md-12 col-xs-12 col-sm-12">\n                <legend>权限</legend>\n\n                <div class="btn-group" data-toggle="buttons">\n                    <label class="btn btn-primary ', escape((11, user.privilege === 1? "active":"" )), '">\n                        <input type="radio" name="privilege" ', escape((12, user.privilege === 1? "checked":"" )), ' value="1"> 只读\n                    </label>\n                    <label class="btn btn-primary ', escape((14, user.privilege === 2? "active":"" )), '">\n                        <input type="radio" name="privilege" ', escape((15, user.privilege === 2? "checked":"" )), '  value="2"> 运行\n                    </label>\n                    <label class="btn btn-primary ', escape((17, user.privilege === 4? "active":"" )), '">\n                        <input type="radio" name="privilege"  ', escape((18, user.privilege === 4? "checked":"" )), '  value="4"> 编辑\n                    </label>\n                </div>\n            </fieldset>\n        </div>\n    </div>\n');24;}; buf.push('\n'); })();
} 
return buf.join('');
})
...
var buf = [];
with (locals || {}) { (function(){ 
 buf.push('');1;if(locals.data) {; buf.push('\n    <div class="row">\n        <div class="col-md-1 col-xs-1 col-sm-1"/>\n\n        <div class="col-md-5 col-xs-5 col-sm-5 userInfo">\n            ', escape((6, data.name)), '\n        </div>\n        ');8;console.log(1111, locals.data.diable_privilege);; buf.push('\n        ');9;if (!locals.data.diable_privilege) {; buf.push('\n        <div class="col-md-5 col-xs-5 col-sm-5 privilege">\n            <fieldset class="col-md-12 col-xs-12 col-sm-12">\n                <legend>权限</legend>\n                <div class="btn-group" data-toggle="buttons">\n                    <label class="btn btn-primary ', escape((14, data.privilege === 1? "active":"" )), '">\n                        <input type="radio" name="privilege" ', escape((15, data.privilege === 1? "checked":"" )), ' value="1"> 只读\n                    </label>\n                    <label class="btn btn-primary ', escape((17, data.privilege === 2? "active":"" )), '">\n                        <input type="radio" name="privilege" ', escape((18, data.privilege === 2? "checked":"" )), '  value="2"> 运行\n                    </label>\n                    <label class="btn btn-primary ', escape((20, data.privilege === 4? "active":"" )), '">\n                        <input type="radio" name="privilege"  ', escape((21, data.privilege === 4? "checked":"" )), '  value="4"> 编辑\n                    </label>\n                </div>\n            </fieldset>\n        </div>\n        ');26;}; buf.push('\n    </div>\n');28;}; buf.push('\n'); })();
} 
return buf.join('');
})
...
},{"./templates/grid.ejs":7,"./templates/list.ejs":8,"./templates/partials/grid_row.ejs":9,"./templates/partials/list_menu.ejs":10,"./templates/partials/menu_button.ejs":11,"./templates/partials/modal_add_input_sub_template.ejs":12,"./templates/partials/modal_add_sub_template.ejs":13,"./templates/partials/modal_common_add.ejs":14,"./templates/partials/modal_common_create.ejs":15,"./templates/partials/modal_edit_user.ejs":16,"./templates/partials/modal_modify_privilege.ejs":17,"./templates/partials/modal_module_group.ejs":18,"./templates/partials/modal_user_group.ejs":19,"backbone":4,"underscore":6}]},{},[2]);
