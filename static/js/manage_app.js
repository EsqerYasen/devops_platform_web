...
},{"./model":3,"./view":5,"backbone":7,"underscore":9}],2:[function(require,module,exports){
var $ = require('jquery');
var Backbone = require('backbone');
Backbone.$ = $;
...
},{"./app":1,"backbone":7,"jquery":8}],3:[function(require,module,exports){
var Backbone = require('backbone');
var $ = require('jquery');
...
},{"../config.json":6,"backbone":7,"jquery":8}],4:[function(require,module,exports){
...
with (locals || {}) { (function(){ 
 buf.push('');1;if(locals.item) {; buf.push('\n<tr>\n    <td>\n        <input type="checkbox" class="i-checks icheck" id="', escape((4,  locals.item.id )), '" name="trCheckbox">\n    </td>\n    <td>', escape((6,  locals.item.name )), '</td>\n    <td>', escape((7,  locals.item.tool_name )), '</td>\n    <td>', escape((8,  locals.item.tool_version )), '</td>\n    <td>', escape((9,  locals.item.created_by )), '</td>\n    <td>', escape((10,  locals.item.updated_by )), '</td>\n    <td>', escape((11,  locals.item.create_time )), '</td>\n    <td>', escape((12,  locals.item.update_time )), '</td>\n    <td>\n        ');14; if (Math.max(locals.item.mp_v, locals.item.mgp_v, locals.item.ug_v)>=4) {; buf.push('\n            <a href="../', escape((15,  locals.item.id )), '/edit/" class="btn btn-sm btn-success"><i class="fa fa-edit"></i>&nbsp;编辑</a>\n        ');16;}; buf.push('\n        ');17; if (Math.max(locals.item.mp_v, locals.item.mgp_v, locals.item.ug_v)>=2) {; buf.push('\n            <a href="javascript:void(0)" class="btn btn-sm btn-success" onclick="appOperation(\'', escape((18,  locals.item.id )), '\',\'', escape((18,  locals.item.name )), '\',\'', escape((18,  locals.item.tool_id )), '\',\'', escape((18,  locals.item.tool_version )), '\',\'', escape((18,  locals.item.command_set_id )), '\',\'', escape((18,  locals.item.bind_type )), '\')"><i class="fa fa-play"></i>安装</a>\n        ');19;}; buf.push('\n        ');20; if (Math.max(locals.item.mp_v, locals.item.mgp_v, locals.item.ug_v)>=1) {; buf.push('\n            <a href="/platform/command_set/', escape((21,  locals.item.id )), '/execLog?deploy_id=', escape((21,  locals.item.id )), '&bind_type=1&name=', escape((21,  locals.item.name )), '&exec_type=3" class="btn btn-sm btn-success"><i class="fa fa-list"></i>&nbsp;历史</a>\n        ');22;}; buf.push('\n        ');23; if (Math.max(locals.item.mp_v, locals.item.mgp_v, locals.item.ug_v)>=4) {; buf.push('\n            <a href="javascript:void(0)" onclick="deleteApp(\'', escape((24,  locals.item.id )), '\')" class="btn  btn-sm btn-danger"><i class="fa fa-trash"></i>&nbsp;删除</a>\n        ');25;}; buf.push('\n    </td>\n</tr>\n');28;}; buf.push('\n'); })();
} 
return buf.join('');
})
    ...
    appendToGrid: function(param) {
      ...
      if (lists.length) {
        $.each(lists, function(i, item) {
          $('.app_manage_list tbody').append(gridTemplate({
            item: item
          }));
        }.bind(this))
      }
...
},{"./templates/partials/grid.ejs":4,"backbone":7,"underscore":9}],6:[function(require,module,exports){
module.exports={
  "url":{
