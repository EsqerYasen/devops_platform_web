...
with (locals || {}) { (function(){ 
 buf.push('');1;if(locals.item) {; buf.push('\n<tr>\n    <td>\n        <input type="checkbox" class="i-checks icheck" id="', escape((4,  locals.item.id )), '" name="trCheckbox">\n    </td>\n    <td>', escape((6,  locals.item.name )), '</td>\n    <td>', escape((7,  locals.item.tool_name )), '</td>\n    <td>', escape((8,  locals.item.tool_version )), '</td>\n    <td>', escape((9,  locals.item.created_by )), '</td>\n    <td>', escape((10,  locals.item.updated_by )), '</td>\n    <td>', escape((11,  locals.item.create_time )), '</td>\n    <td>', escape((12,  locals.item.update_time )), '</td>\n    <td>\n        ');14; if (Math.max(locals.item.mp_v, locals.item.mgp_v, locals.item.ug_v)>=4) {; buf.push('\n            <a href="../', escape((15,  locals.itemid )), '/edit/" class="btn btn-sm btn-success"><i class="fa fa-edit"></i>&nbsp;编辑</a>\n        ');16;}; buf.push('\n        ');17; if (Math.max(locals.item.mp_v, locals.item.mgp_v, locals.item.ug_v)>=2) {; buf.push('\n            <a href="javascript:void(0)" class="btn btn-sm btn-success" onclick="flowOperation(\'', escape((18,  locals.itemid )), '\',\'', escape((18,  locals.itemname )), '\',\'', escape((18,  locals.itemtool_id )), '\',\'', escape((18,  locals.itemtool_version )), '\',\'', escape((18,  locals.itemcommand_set_id )), '\',\'', escape((18,  locals.itembind_type )), '\')"><i class="fa fa-play"></i>调度</a>\n        ');19;}; buf.push('\n\n        ');21; if (Math.max(locals.item.mp_v, locals.item.mgp_v, locals.item.ug_v)>=1) {; buf.push('\n            <a href="/platform/command_set/', escape((22,  locals.itemid )), '/execLog?deploy_id=', escape((22,  locals.itemid )), '&bind_type=1&name=', escape((22,  locals.itemname )), '&exec_type=4" class="btn btn-sm btn-success"><i class="fa fa-list"></i>&nbsp;历史</a>\n        ');23;}; buf.push('\n        ');24; if (Math.max(locals.item.mp_v, locals.item.mgp_v, locals.item.ug_v)>=4) {; buf.push('\n            <a href="javascript:void(0)" onclick="deleteApp(\'', escape((25,  locals.itemid )), '\')" class="btn  btn-sm btn-danger"><i class="fa fa-trash"></i>&nbsp;删除</a>\n        ');26;}; buf.push('\n    </td>\n</tr>\n');29;}; buf.push('\n'); })();
} 
return buf.join('');
})
...
},{"./templates/partials/grid.ejs":5,"backbone":7,"underscore":9}],7:[function(require,module,exports){
(function (global){
//     Backbone.js 1.2.3
