...
module.exports={
  "url":{
    "job": "http://127.0.0.1:8005",
  },
  "type":{
    "job": {
        "collection": "platform_deploy_tool_deploy_tool",
        "dataset": "devops_workshop_dev_job"
    },
    "app_manage": {
        "collection": "platform_app_manage_app_manage",
        "dataset": "devops_workshop_dev_job"
    },
  }
}
...
},{"./model":4,"./view":6,"backbone":7,"underscore":9}],3:[function(require,module,exports){
var $ = require('jquery');
var Backbone = require('backbone');
Backbone.$ = $;
...
},{"./app":2,"backbone":7,"jquery":8}],4:[function(require,module,exports){
var Backbone = require('backbone');
var $ = require('jquery');
...
},{"../config.json":1,"backbone":7,"jquery":8}],5:[function(require,module,exports){
...
with (locals || {}) { (function(){ 
 buf.push('');1;if(locals.item) {; buf.push('\n<tr data-id="', escape((2, locals.item.id)), '">\n    <td>\n        <input type="checkbox" class="i-checks icheck" id=" ', escape((4, locals.item.id)), ' " name="trCheckbox">\n    </td>\n    <td> ', escape((6, locals.item.name)), ' </td>\n    <td> ', escape((7, locals.item.current_version)), ' </td>\n    <td> ', escape((8, locals.item.tool_name)), ' </td>\n    <td> ', escape((9, locals.item.tool_version ? locals.item.tool_version: "None")), ' </td>\n    <td> ', escape((10, locals.item.created_by)), ' </td>\n    <td> ', escape((11, locals.item.updated_by)), ' </td>\n    <td> ', escape((12, locals.item.create_time)), ' </td>\n    <td> ', escape((13, locals.item.update_time)), ' </td>\n    <td>\n        <select id="versions" class="form-control" style="width: 90%">\n            <option value="" >请选择</option>\n            ');17;if (locals.versions) {; buf.push('\n                ');18;$.each (locals.versions, function(i, ver) {; buf.push('\n                    <option value=" ', escape((19, ver.version)), '" ', escape((19, ver.version == locals.item.current_version? "selected":"")), ' > ', escape((19, ver.version)), ' </option>\n                ');20;}); buf.push('\n            ');21;}; buf.push('\n        </select>\n    </td>\n    <td>\n        ');25; if (Math.max(locals.item.mp_v, locals.item.mgp_v, locals.item.ug_v)>=4) {; buf.push('\n            <a  href="../', escape((26, locals.item.id)), '/edit/" class="btn btn-sm btn-success"><i class="fa fa-edit"></i>编辑</a>\n        ');27;}; buf.push('\n        ');28; if (Math.max(locals.item.mp_v, locals.item.mgp_v, locals.item.ug_v)>=2) {; buf.push('\n            <a onclick="deployToolOperation(\'', escape((29, locals.item.id)), '\',\'', escape((29, locals.item.name)), '\',\'', escape((29, locals.item.tool_id)), '\',\'', escape((29, locals.item.tool_version)), '\',\'', escape((29, locals.item.command_set_id)), '\',\'', escape((29, locals.item.bind_type)), '\')" class="btn btn-sm btn-success"><i class="fa fa-play"></i>发版</a>\n        ');30;}; buf.push('\n        ');31; if (Math.max(locals.item.mp_v, locals.item.mgp_v, locals.item.ug_v)>=1) {; buf.push('\n            <a href="/platform/command_set/', escape((32, locals.item.id)), '/execLog?deploy_id=', escape((32, locals.item.id)), '&bind_type=1&name=', escape((32, locals.item.name)), '&exec_type=2" class="btn btn-sm btn-success"><i class="fa fa-list"></i>历史</a>\n        ');33;}; buf.push('\n        ');34; if (Math.max(locals.item.mp_v, locals.item.mgp_v, locals.item.ug_v)>=4) {; buf.push('\n           <a class="btn  btn-sm btn-danger" onclick="deleteDeployTool(\'', escape((35, locals.item.id)), '\')"><i class="fa fa-trash"></i>删除</a>\n        ');36;}; buf.push('\n    </td>\n</tr>\n');39;}; buf.push('\n'); })();
} 
return buf.join('');
})
...
},{"../config.json":1,"./templates/partials/grid.ejs":5,"backbone":7,"underscore":9}],7:[function(require,module,exports){
(function (global){
//     Backbone.js 1.2.3
